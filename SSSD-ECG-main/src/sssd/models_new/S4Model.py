...
# Removed pytorch_lightning dependency - replaced with simple wrapper
def rank_zero_only(fn):
    """Simple replacement for pytorch_lightning's rank_zero_only decorator.
    In single-GPU or non-distributed setups, this just returns the function as-is.
    For multi-GPU support, you would need to check the actual rank and conditionally execute.
    """
    return fn
